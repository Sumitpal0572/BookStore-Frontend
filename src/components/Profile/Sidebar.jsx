    ...
    <div className="bg-zinc-800 p-4 rounded flex flex-col items-between justify-center h-[100%]">
      ...
      {role === "user" && (
        <div className="w-full  flex-col items-center justify-center hidden lg:flex">
          ...
          <Link
            to="/profile/settings"
            className="text-zinc-100font-semibold w-full py-2 mt-4 text-center hover:bg-zinc-900 rounded transition-all duration-300"
          >
            Settings
          </Link>
        </div>
      ...
      {role === "admin" && (
        <div className="w-full flex-col lg:flex hidden items-center justify-between ">
          <Link
            to="/profile"
            className="text-zinc-100 font-semibold w-full py-2  text-center hover:bg-zinc-900 rounded transition-all duration-300"
          >
